...
#pragma warning restore 67
        ...
        public NpcViewModel(INpc npc, IAsyncEnumerable<Mugshot> mugshots)
        {
            ...
            Mugshots = mugshots
                ...
                // Hide cards whose plugin isn't loaded: they can't be selected as a face source and are just clutter.
                // The base-game (Vanilla) card is always kept.
                .Where(x => x.IsBaseGame || x.IsPluginLoaded)
