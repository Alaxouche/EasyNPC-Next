...
namespace Focus.Apps.EasyNpc.Build.UI
{
    ...
    public class BuildTaskViewModel : IDisposable
    {
        ...
        // Live "44 / 814" style count shown next to the progress bar while a step is working.
        [DependsOn(nameof(CurrentProgress), nameof(MaxProgress), nameof(State))]
        public string ProgressText =>
            MaxProgress > 0 && (State == BuildTaskState.Running || State == BuildTaskState.Paused)
