...
namespace Focus.Analysis.Records
{
    public class NpcAnalysis : RecordAnalysis
    {
        ...
        // Character-generation face presets (the "Is CharGen Face Preset" flag). These are actor records used only by
        // the character creation menu; they never get FaceGen files, so treating them like NPCs produces bogus
        // "missing FaceGen" warnings.
        public bool IsChargenFacePreset { get; init; }
